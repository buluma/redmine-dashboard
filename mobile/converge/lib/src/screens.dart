                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      FilterChip(
                        ...
                        onSelected: (_) {
                          setState(() {
                            _searchMode = _searchMode == "hybrid"
                                ? "local"
                                : "hybrid";
                          });
                          _load(reset: true);
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        _sectionCard(
                          ...
                          child: MarkdownBody(
                            data: _normalizeIssueDescription(
                              _issue!.description,
                            ),
                            selectable: true,
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      const SizedBox(height: 8),
                                      if (_aiCategory!.suggestedPriority !=
                                          null)
                                        Text(
                                      ...
                                      if (_aiCategory!.suggestedCategory !=
                                          null)
                                        Text(
                        ...
                        _sectionCard(
                          ...
                          onExpandedChanged: (value) {
                            ...
                            if (value &&
                                !_attachmentHeaders.containsKey(
                                  "Authorization",
                                )) {
