  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: <Widget>[
            TextField(controller: _baseUrl, decoration: const InputDecoration(labelText: "Redmine Base URL")),
            TextField(controller: _apiKey, decoration: const InputDecoration(labelText: "Redmine API Key")),
...
class IssueListScreen extends StatefulWidget {
  ...
  final void Function(int issueId) onSelectIssue;
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  ...
                  subtitle: Text("${issue.statusName} • ${issue.priority ?? "-"} • GH ${issue.githubLinks.length}"),
                  onTap: () => widget.onSelectIssue(issue.redmineIssueId),
                );
              },
            ),
          ),
                  ...
                  : SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          ElevatedButton(onPressed: _postComment, child: const Text("Post Comment")),
                          const SizedBox(height: 16),
                          TextField(controller: _repo, decoration: const InputDecoration(labelText: "Repository (owner/repo)")),
                          TextField(controller: _ghIssue, decoration: const InputDecoration(labelText: "GitHub Issue #")),
                          const SizedBox(height: 8),
                          ElevatedButton(onPressed: _addGithubLink, child: const Text("Add GitHub Link")),
                          const SizedBox(height: 16),
